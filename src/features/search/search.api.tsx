...
const searchApi = algoliaApi.injectEndpoints({
  endpoints: (build) => ({
...
const { useLazySearchBlogPostsQuery, useSearchBlogPostsQuery, useSearchBlogQuery } = searchApi

export { searchApi, useLazySearchBlogPostsQuery, useSearchBlogPostsQuery, useSearchBlogQuery }
